...
np.save('q_data/q_data.npy', np.array([np.r_[-1, np.zeros(32)]]))  # ,(16,1)))
np.save('all_data/all_data.npy', np.array([np.r_[-1, np.zeros(32)]]))  # ,(16,1)))
with open('moves.txt', 'w') as f:
    f.write('')

# np.save('thetas/theta_q.npy', np.zeros((6, 32)))
