...
def reward_update_(self):
        ...
        rewards = {"MOVED_LEFT" : -2+features[1]+0.2*features[3]+0.2*features[5]-3*features[7]-2*features[18]+0.7*features[22]+0.1*features[24], 
                    "MOVED_RIGHT" : -2-features[1]-0.2*features[3]+0.2*features[5]-3*features[8]-2*features[19]-0.7*features[22]-0.1*features[24],
                    "MOVED_UP" : -2+features[2]+0.2*features[4]+0.2*features[6]-3*features[9]-2*features[20]+0.7*features[23]+0.1*features[25],
                    "MOVED_DOWN" : -2-features[2]-0.2*features[4]+0.2*features[6]-3*features[10]-2*features[21]-0.7*features[23]-0.1*features[25],
                    "WAITED" : -6 - 40 * features[11], 
                    "INTERRUPTED" : -1,
                    "INVALID_ACTION" : -5 - 5*features[5] - 5*features[6] - 20*features[12] - 10*np.clip(np.sum(features[14:18]), 0, 1),
                    
                    "BOMB_DROPPED" :  -6 + 5*features[13],
                    "BOMB_EXPLODED" : 0, 
