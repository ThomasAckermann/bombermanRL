...
def reward_update_(self):
    ...
    event_dict = {0 : "MOVED_LEFT",
            ...
            16 : "SURVIVED_ROUND"}
    f = features
    rewards = {"MOVED_LEFT" : -2 + f[1] + 0.2*f[3] + 0.2*f[5] - 3*f[7] - 30*f[18] + 1*f[22] + 0.4*f[24] - 18*f[27], 
                    "MOVED_RIGHT" : -2 - f[1] - 0.2*f[3] + 0.2*f[5] - 3*f[8] - 30*f[19] - 1*f[22] - 0.4*f[24] - 18*f[28],
                    "MOVED_UP" : -2 + f[2] + 0.2*f[4] + 0.2*f[6] - 3*f[9] - 30*f[20] + 1*f[23] + 0.4*f[25] - 18*f[29],
                    "MOVED_DOWN" : -2 - f[2] - 0.2*f[4] + 0.2*f[6] - 3*f[10] - 30*f[21] - 1*f[23] - 0.4*f[25] - 18*f[30],
                    "WAITED" : -2 - 100*f[11], 
                    "INTERRUPTED" : -1,
